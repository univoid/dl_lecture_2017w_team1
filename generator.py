...
class Generator(object):
    def __init__(self, num_emb, batch_size, emb_dim, hidden_dim,
                 ...
                 learning_rate=0.01, reward_gamma=0.95, cond=0):
        ...
        if cond:
            ...
            self.initial_hidden_state = tf.nn.embedding_lookup(self.g_embeddings, self.cond)
            self.h0 = tf.zeros([self.batch_size, self.hidden_dim])
            self.h0 = tf.stack([self.initial_hidden_state, self.h0]) # previous_hidden_state, c_prev
        else:
            # Initial states
            self.h0 = tf.zeros([self.batch_size, self.hidden_dim])
